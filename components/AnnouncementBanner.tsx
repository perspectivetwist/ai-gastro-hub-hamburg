...
export default function AnnouncementBanner() {
  ...
  if (pathname === "/hamburg-ki-studie-2026") return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          <span className="font-semibold">80% der Hamburger Restaurants unsichtbar für KI.</span>{" "}
          Studie lesen
        </span>
        <span
